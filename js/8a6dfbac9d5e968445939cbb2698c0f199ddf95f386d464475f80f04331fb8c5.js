!function () {
    ...
    const t = async e => {
            ...
            a && n(e)
                ...
                : a
                    ? r()
                    : null != e.firstElementChild && t(e.firstElementChild)
        },
        n = e => {
            const t = e
    ...
    !function (t, n = Number.MAX_VALUE) {
        var a;
        (
            window.canva_scriptExecutor = null !== (a = window.canva_scriptExecutor) && void 0 !== a
                ? a
                : new e
        ).runOnLoad({callback: t, priority: n})
    }((() => {
        (() => {
